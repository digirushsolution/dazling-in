...
function vamtam_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     => esc_html__( 'Advanced AJAX Product Filters for WooCommerce', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'Extra Product Options (Product Addons) for WooCommerce', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'FiboSearch - AJAX Search for WooCommerce', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'WooCommerce', 'vamtam-debebe' ),
			'slug'     => 'woocommerce',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'PW WooCommerce Gift Cards', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'WPC Smart Wishlist for WooCommerce', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'Smash Balloon Social Photo Feed', 'vamtam-debebe' ),
			'slug'     => 'instagram-feed',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'Elementor', 'vamtam-debebe' ),
			'slug'     => 'elementor',
			'required' => true,
			'category' => 'required',
			'version'  => '2.7.4',
		...
		array(
			'name'     => esc_html( sprintf( __( 'Vamtam Elementor Integration (%s)', 'vamtam-debebe' ), VAMTAM_THEME_SLUG ) ),
		...
		array(
			'name'     => esc_html( sprintf( __( 'Vamtam Product Q&A', 'vamtam-debebe' ), VAMTAM_THEME_SLUG ) ),
		...
		array(
			'name'     => esc_html__( 'Vamtam Importers (E)', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'Wordpress SEO', 'vamtam-debebe' ),
			'slug'     => 'wordpress-seo',
			'required' => false,
		...
		array(
			'name'     => esc_html__( 'WooCommerce Payments', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'WooCommerce PayPal Payments', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'Really Simple SSL', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'Loco Translate', 'vamtam-debebe' ),
			'slug'     => 'loco-translate',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'UpDraftPlus', 'vamtam-debebe' ),
			'slug'     => 'updraftplus',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'WP Super Cache', 'vamtam-debebe' ),
			'slug'     => 'wp-super-cache',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Limit Login Attempts Reloaded', 'vamtam-debebe' ),
		...
		array(
			'name'     => esc_html__( 'Wordfence', 'vamtam-debebe' ),
			'slug'     => 'wordfence',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'CookieYes | GDPR Cookie Consent & Compliance Notice (CCPA Ready)', 'vamtam-debebe' ),
...
function vamtam_tgmpa_table_columns( $columns ) {
	...
	$columns = array(
		...
		'img'         => '',
		'plugin'      => esc_html__( 'Name', 'vamtam-debebe' ),
		'description' => esc_html__( 'Description', 'vamtam-debebe' ),
		'status'      => esc_html__( 'Status', 'vamtam-debebe' ),
		'version'     => esc_html__( 'Version', 'vamtam-debebe' ),
	);
	return $columns;
}
...
function vamtam_tgmpa_table_data_item( $item, $plugin )
{
	...
	if( isset( $plugin_data['Description'] ) ) {
		...
		$item['description'] =  esc_html__( 'A simple WordPress Plugin.', 'vamtam-debebe' );
	}
	if ( strpos( $plugin['slug'], 'vamtam-debebe' ) !== false ) {
		$item['description'] =  esc_html__( 'Theme Exclusive.', 'vamtam-debebe' );
	}
...
function vamtam_tgmpa_admin_menu_args( $args ) {
	$args['page_title'] = esc_html__( 'Install Plugins', 'vamtam-debebe' );
