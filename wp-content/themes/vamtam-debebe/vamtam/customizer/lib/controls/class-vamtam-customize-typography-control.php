...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'vamtam-debebe' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'vamtam-debebe' ),
			'font-weight'                     => esc_html__( 'Weight', 'vamtam-debebe' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'vamtam-debebe' ),
				'uppercase'    => esc_html__( 'Uppercase', 'vamtam-debebe' ),
				'lowercase'    => esc_html__( 'Lowercase', 'vamtam-debebe' ),
				'capitalize'   => esc_html__( 'Capitalize', 'vamtam-debebe' ),
				'normal'       => esc_html__( 'Normal', 'vamtam-debebe' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'vamtam-debebe' ),
				'normal'       => esc_html__( 'Normal', 'vamtam-debebe' ),
				'italic'       => esc_html__( 'Italic', 'vamtam-debebe' ),
				'oblique'      => esc_html__( 'Oblique', 'vamtam-debebe' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'vamtam-debebe' ),
				'underline'    => esc_html__( 'Underline', 'vamtam-debebe' ),
				'overline'     => esc_html__( 'Overline', 'vamtam-debebe' ),
				'line-through' => esc_html__( 'Line Through', 'vamtam-debebe' ),
				'none'         => esc_html__( 'None', 'vamtam-debebe' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'vamtam-debebe' ),
			'line-height'                => esc_html__( 'Line Height', 'vamtam-debebe' ),
			'color'                      => esc_html__( 'Font Color', 'vamtam-debebe' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'vamtam-debebe' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'vamtam-debebe' ), [ 'code' => [] ] ),
		);
	}
	/**
