...
class Vamtam_Customize_Responsive_Box_Fields_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'top'       => esc_html__( 'Top', 'vamtam-debebe' ),
			'right'     => esc_html__( 'Right', 'vamtam-debebe' ),
			'bottom'    => esc_html__( 'Bottom', 'vamtam-debebe' ),
			'left'      => esc_html__( 'Left', 'vamtam-debebe' ),
			'padding'   => esc_html__( 'Padding', 'vamtam-debebe' ),
		);
	}
	/**
