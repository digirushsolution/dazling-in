...
class VamtamFramework {
	...
	public static function theme_supports() {
		...
		function vamtam_elementor_widgets_support( bool $supports, array $args, string $feature ) {
			...
			$base_features = [
				...
				// To be ported.
				'woocommerce-product-data-tabs--mobile-hr-layout', // Debebe-after.
			];
			...
			$theme_features = [
				...
				'products-base--onsale-badge-theme-mask',
				'products-base--new-badge-section',
				'woocommerce-product-data-tabs--hide-tabs-toggles',
				'woocommerce-product-images--onsale-badge-theme-mask',
				'woocommerce-product-images--new-badge-section',
				'posts-base--read-more-theme-underline',
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'primary-menu'     => esc_html__( 'Menu Header', 'vamtam-debebe' ),
				)
			);
		}
	}
	...
	private function load_languages() {
		load_theme_textdomain( 'vamtam-debebe', VAMTAM_THEME_DIR . 'languages' );
	}
	...
	public static function license_valid() {
		...
		esc_html_e( 'Valid Purchase Key.', 'vamtam-debebe' );
		echo '<p>';
		esc_html_e( 'Congratulations! You have succesfully registered your product.', 'vamtam-debebe' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_invalid() {
		echo '<span id="fail">';
		esc_html_e( 'Incorrect Purchase Key.', 'vamtam-debebe' );
		echo '<p>';
		esc_html_e( 'Please check your purchase code and re-enter.', 'vamtam-debebe' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_failed() {
		...
		esc_html_e( 'Cannot validate Purchase Key. Please try again later. If the problem persists your server might not have the curl PHP extension enabled.', 'vamtam-debebe' );
		echo '</span>';
	}
	...
	public static function license_unregister() {
		esc_html_e( 'Unregistered Key.', 'vamtam-debebe' );
	}
}
