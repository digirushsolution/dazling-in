...
class VamtamElementorBridge {
	...
	public static function add_sticky_header_bg_color_to_elementor_global_settings() {
		...
		$kit->add_repeater_row( 'system_colors', [
			...
			'title' => __( 'Sticky Header Bg Color', 'vamtam-debebe' ),
	...
	*/
		...
		if ( $use_el_global_defaults ) {
			...
			for ( $i = 1; $i <= 8; $i++ ) {
				...
				$kit->add_repeater_row( 'system_colors', [
					...
					'title' => sprintf( __( 'Accent %s', 'vamtam-debebe' ), $i ),
	...
	protected static function add_theme_fonts_to_elementor_global_fonts() {
		...
		if ( $use_el_global_defaults ) {
			...
			// Adding from vamtam_get_option().
			$our_fonts = [
				'primary-font' => __( 'Primary Font', 'vamtam-debebe' ),
				'h1'           => __( 'H1', 'vamtam-debebe' ),
				'h2'           => __( 'H2', 'vamtam-debebe' ),
				'h3'           => __( 'H3', 'vamtam-debebe' ),
				'h4'           => __( 'H4', 'vamtam-debebe' ),
				'h5'           => __( 'H5', 'vamtam-debebe' ),
				'h6'           => __( 'H6', 'vamtam-debebe' ),
			];
			...
			foreach ( $our_fonts as $font_prefix => $font_title ) {
				...
				$kit->add_repeater_row( 'system_colors', [
					...
					'title' => sprintf( __( '%s', 'vamtam-debebe' ), $font_title ),
	...
	public static function register_locations( $elementor_theme_manager ) {
		...
		$elementor_theme_manager->register_location(
			'page-title-location',
			[
				'label' => esc_html__( 'Page Title', 'vamtam-debebe' ),
				'multiple' => true,
	...
	public static function get_widget_mods_list() {
		...
		*/
		...
		$widget_mods_list = [
			...
			'button'                                     => [ 'label' => __( 'Button', 'vamtam-debebe' ) ],
			'form'                                       => [ 'label' => __( 'Form', 'vamtam-debebe' ) ],
			'tabs'                                       => [ 'label' => __( 'Tabs', 'vamtam-debebe' ) ],
			'image'                                      => [ 'label' => __( 'Image', 'vamtam-debebe' ) ],
			'icon-box'                                   => [ 'label' => __( 'Icon Box', 'vamtam-debebe' ) ],
			'nav-menu'                                   => [ 'label' => __( 'Nav Menu', 'vamtam-debebe' ) ],
			'section'                                    => [ 'label' => __( 'Section', 'vamtam-debebe' ) ],
			'toggle'                                     => [ 'label' => __( 'Toggle', 'vamtam-debebe' ) ],
			'share-buttons'                              => [ 'label' => __( 'Share Buttons', 'vamtam-debebe' ) ],
			'shortcode'                                  => [ 'label' => __( 'Shortcode', 'vamtam-debebe' ) ],
			'testimonial-carousel'                       => [ 'label' => __( 'Testimonial Carousel', 'vamtam-debebe' ) ],
			'woocommerce-menu-cart'                      => [ 'label' => __( 'Menu Cart', 'vamtam-debebe' ) ],
			'wc-loops-common-mods'                       => [ 'label' => __( 'WooCommerce Loops (common)', 'vamtam-debebe' ) ],
			'woocommerce-products'                       => [ 'label' => __( 'Products', 'vamtam-debebe' ) ],
			'wc-archive-products'                        => [ 'label' => __( 'Archive Products', 'vamtam-debebe' ) ],
			'wc-categories'                              => [ 'label' => __( 'Product Categories', 'vamtam-debebe' ) ],
			'woocommerce-product-related'                => [ 'label' => __( 'Product Related', 'vamtam-debebe' ) ],
			'woocommerce-product-upsell'                 => [ 'label' => __( 'Upsells', 'vamtam-debebe' ) ],
			'woocommerce-product-images'                 => [ 'label' => __( 'Product Images', 'vamtam-debebe' ) ],
			'woocommerce-product-price'                  => [ 'label' => __( 'Product Price', 'vamtam-debebe' ) ],
			'woocommerce-product-add-to-cart'            => [ 'label' => __( 'Add To Cart', 'vamtam-debebe' ) ],
			'woocommerce-product-data-tabs'              => [ 'label' => __( 'Product Data Tabs', 'vamtam-debebe' ) ],
			'woocommerce-product-rating'                 => [ 'label' => __( 'Product Rating', 'vamtam-debebe' ) ],
			'woocommerce-product-additional-information' => [ 'label' => __( 'Product Additional Information', 'vamtam-debebe' ) ],
			'archive-posts'                              => [ 'label' => __( 'Archive Posts', 'vamtam-debebe' ) ],
			'paypal-button'                              => [ 'label' => __( 'Paypal Button', 'vamtam-debebe' ) ],
			'posts'                                      => [ 'label' => __( 'Posts', 'vamtam-debebe' ) ],
			'popup' /* Not a widget but same logic */    => [ 'label' => __( 'Popup', 'vamtam-debebe' ) ],
			'post-comments'                              => [ 'label' => __( 'Post Comments', 'vamtam-debebe' ) ],
			'wc-elements'                                => [ 'label' => __( 'WooCommerce Pages', 'vamtam-debebe' ) ],
			'woocommerce-cart'                           => [ 'label' => __( 'WooCommerce Cart', 'vamtam-debebe' ) ],
			'woocommerce-checkout-page'                  => [ 'label' => __( 'WooCommerce Checkout', 'vamtam-debebe' ) ],
			'woocommerce-purchase-summary'               => [ 'label' => __( 'WooCommerce Purchase Summary', 'vamtam-debebe' ) ],
			'woocommerce-my-account'                     => [ 'label' => __( 'WooCommerce My Account', 'vamtam-debebe' ) ],
			'wp-widget-instagram-feed-widget'            => [ 'label' => __( 'Instagram Feed', 'vamtam-debebe' ) ],
			'wp-widget-dgwt_wcas_ajax_search'            => [ 'label' => __( 'FiboSearch Bar', 'vamtam-debebe' ) ],
			'wp-widget-berocket_aapf_group'              => [ 'label' => __( 'AAPF Filters Group', 'vamtam-debebe' ) ],
		];
	...
	public static function get_wc_mods_list() {
		...
		$wc_mods_list = [
			...
			'wc_products_new_badge' => [
				'label'       => __( '"New" badge for products.', 'vamtam-debebe' ),
				'description' => __( 'Adds an option to allow marking products as new. The option is added on the products edit page under the advanced tab.', 'vamtam-debebe' ),
			],
		];
	...
	*/
	...
	public static function extract_zip( $file, $to ) {
		...
		if ( ! $unzip_result ) {
			$unzip_result = new \WP_Error( 'error', esc_html__( 'Could not unzip or empty archive.', 'vamtam-debebe' ) );
		}
