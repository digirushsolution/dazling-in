	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'vamtam-debebe' ),
				'iconName'   => esc_html__( 'Icon', 'vamtam-debebe' ),
				'iconText'   => esc_html__( 'Text', 'vamtam-debebe' ),
				'iconLink'   => esc_html__( 'Link', 'vamtam-debebe' ),
				'iconChange' => esc_html__( 'Change', 'vamtam-debebe' ),
